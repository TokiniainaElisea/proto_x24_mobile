<div class="modal fade shadow-lg" id="new_mouvement" aria-hidden="true" tabindex="-1">
    ...
    <div class="modal-dialog modal-dialog-centered">
        ...
        <div class="modal-content border-0 shadow">
            ...
            <div class="modal-body p-4">
                ...
                <form action="{{route('new_mouvement')}}" method="post">

                    @csrf
                    
                    <input type="number" class="d-none" name="product_id" value="{{$product_id}}">
                    {{-- Quantité --}}
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="provider_price" id="provider_price" class="form-control"
                                min="0" placeholder="Prix d'achat">
