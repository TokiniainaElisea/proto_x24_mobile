                ...
                <form action="{{ route('new_client') }}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" name="phone" placeholder="Numéro de téléphone">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="adress" class="form-control" placeholder="Ex : Lot II A 123">
